...
<html>
    <head>
		...
		<!-- Mandatory tags -- Don't touch -->
        <title>עדכון פרטי תלמיד</title>
	...
	<!-- Page specific content -->
        ...
        <div class="container">
            ...
            <p class="h2 text-center">עדכון פרטי תלמיד מס' <span id="id_to_edit"></span></p>
            <form id="update_student">
                ...
                <div class="form-group row border-0">    
                    ...
                    <div class="border row col-md-9 boxlayout">
                        ...
                        <p class="h6 text-danger">בחר אחד ממספרי הטלפון אשר ישמש עבור הזדהות בכניסה למערכת (ברירת מחדל הוא הטלפון של האם)</p>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            <input class="form-check-input" type="radio" name="phone_number_id" id="phone_number_id_mother" value="1">
                        ...
                        <div class="form-group col-md-4">
                            <input class="form-check-input" type="radio" name="phone_number_id" id="phone_number_id_father" value="2">
                ...
                <div class="form-group">
                    <a class="btn btn-light col-md-3" href="students.php">ביטול</a>
...
$(function() 
{
    ...
    $("#update_student").submit(function(e){
        ...
        // get fields as json
        let json_data = serialize_form("#update_student")
        ...
        send_post_request("./api/student/update", json_data, function(res){ window.location.href = 'students.php?alert=1&msg='+res.msg }, function(res){show_alert(res.responseText)})
